...
//
// NB4+ Memory Optimizations:
// - Reduced array sizes to match actual hardware capabilities
// - slidersConfig: 4 (reduced from MAX_POTS=16)
// - potsConfig: 6 (reduced from 16)
// - switchConfig: 8 (reduced from 20)
// - calib: 12 (reduced from 20) for analog inputs calibration
//
...
static const struct YamlNode struct_RadioData[] = {
  ...
  YAML_ARRAY("slidersConfig", 0, 4, struct_sliderConfig, nullptr),
  YAML_PADDING( 8 ),
  YAML_ARRAY("potsConfig", 4, 6, struct_potConfig, nullptr),
  YAML_ARRAY("switchConfig", 32, 8, struct_switchDef, switchIsActive),
